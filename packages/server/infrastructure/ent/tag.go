...
// was not loaded in eager-loading.
func (e TagEdges) ThreadTagsOrErr() ([]*ThreadTag, error) {
	if e.loadedTypes[1] {
...
func (t *Tag) QueryThreads() *ThreadQuery {
	return NewTagClient(t.config).QueryThreads(t)
}

// QueryThreadTags queries the "thread_tags" edge of the Tag entity.
func (t *Tag) QueryThreadTags() *ThreadTagQuery {
	return NewTagClient(t.config).QueryThreadTags(t)
}
