...
func (tu *TagUpdate) AddThreadIDs(ids ...int) *TagUpdate {
	tu.mutation.AddThreadIDs(ids...)
	return tu
}

// AddThreads adds the "threads" edges to the Thread entity.
func (tu *TagUpdate) AddThreads(t ...*Thread) *TagUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// AddThreadIDs adds the "threads" edge to the Thread entity by IDs.
func (tuo *TagUpdateOne) AddThreadIDs(ids ...int) *TagUpdateOne {
	tuo.mutation.AddThreadIDs(ids...)
	return tuo
}

// AddThreads adds the "threads" edges to the Thread entity.
func (tuo *TagUpdateOne) AddThreads(t ...*Thread) *TagUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// ClearThreads clears all "threads" edges to the Thread entity.
func (tuo *TagUpdateOne) ClearThreads() *TagUpdateOne {
	tuo.mutation.ClearThreads()
	return tuo
}

// RemoveThreadIDs removes the "threads" edge to Thread entities by IDs.
func (tuo *TagUpdateOne) RemoveThreadIDs(ids ...int) *TagUpdateOne {
	tuo.mutation.RemoveThreadIDs(ids...)
	return tuo
}

// RemoveThreads removes "threads" edges to Thread entities.
func (tuo *TagUpdateOne) RemoveThreads(t ...*Thread) *TagUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
