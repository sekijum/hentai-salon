...
type UserFindThreadsRequest struct {
	Limit  int `form:"limit"`
	Offset int `form:"offset"`
}

type UserFindCommentsRequest struct {
	Limit  int `form:"limit"`
	Offset int `form:"offset"`
}

type UserFindLikedCommentsRequest struct {
	Limit  int `form:"limit"`
	Offset int `form:"offset"`
}

type UserFindUnLikedCommentsRequest struct {
	Limit  int `form:"limit"`
	Offset int `form:"offset"`
}
